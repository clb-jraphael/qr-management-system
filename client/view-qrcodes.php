...
<head>
  ...
  <link rel="stylesheet" href="css/view-qrcodes-styles.css">
  <!-- Bootstrap CSS -->
  ...
  <script src="js/search-qr-script.js" defer></script>
</head>
...
<body>
  ...
  <?php
    displayQRCodes($db, $_SESSION['email']);
  ?>
</body>
</html>