<?php 
define('TARGET_SERVER','http://192.168.1.33:3001'); //replace ip address with host ip address
...
<head>
  ...
  <link rel="stylesheet" href="css/view-events-styles.css">
  ...
  <script>
        ...
        const targetServer = "<?php echo TARGET_SERVER; ?>";
  </script>

  <script src="js/generateQR.js" defer></script>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body d-flex flex-column flex-lg-row p-4
          ...
          <div class="d-flex flex-column flex-lg-row
              ...
              ?></p>
            <a href="includes/process-logout.php" class="text-white text-decoration-none px-3 py-1 rounded-4" style="background-color: #27374D;">Logout</a>
          </div>
        </div>
      </div>
    </div>
